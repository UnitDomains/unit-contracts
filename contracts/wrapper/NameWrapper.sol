    ...
    IERC721Receiver
{
    ...
    IENS public immutable override ens;
    ...
    function wrapETH2LD(
        ...
        registrar.reclaim(tokenId, address(this), baseNodeIndex);
    ...
    function renew(
        ...
        return registrar.renew(tokenId, duration, baseNodeIndex);
    }
    ...
    function onERC721Received(
        ...
        (
            ...
            address resolver,
            uint16 baseNodeIndex
        ) = abi.decode(data, (string, address, uint96, address, uint16));
        ...
        // transfer the ens record back to the new owner (this contract)
        registrar.reclaim(uint256(labelhash), address(this), baseNodeIndex);
